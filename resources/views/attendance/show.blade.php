...
@section('title')
    {{ ucwords(str_replace('_', ' ', 'show_attendance')) }}
@endsection
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="id" value="{{ $attendance->id }}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="name" value="{{ $attendance->name }}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" id="address" readonly>{{ $attendance->address }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="place_of_birth" value="{{ $attendance->place_of_birth }}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="date" class="form-control" id="birthday" value="{{ $attendance->birthday }}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="title" value="{{ $attendance->title->name }}" readonly>
                            </div>
                        </div>

                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label" for="attendance_status">{{ ucwords(str_replace('_', ' ', 'attendance_status')) }}</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="attendance_status" value="{{ $attendance->attendance_status->name }}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="education" value="{{ $attendance->education->name }}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="campus" value="{{ $attendance->campus->name }}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="major" value="{{ $attendance->major->name }}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="religion" value="{{ $attendance->religion->name }}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="marital_status" value="{{ $attendance->marital_status->name }}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="bank" value="{{ $attendance->bank->name }}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="{{ $column_name }}" value="{{ $attendance->{$column_name} }}" readonly>
                            </div>
                        </div>
                        @endforeach
                                ...
                                @foreach ($skills as $skill)
                                    <div class="form-check">
                                        <input class="form-check-input skill-checkbox" type="checkbox" name="skill_ids[]"
                                            ...
                                            {{ in_array($skill->id, $attendance_skill_ids) ? 'checked' : '' }} disabled>
