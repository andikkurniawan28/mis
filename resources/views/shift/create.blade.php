...
@section('title')
    {{ ucwords(str_replace('_', ' ', 'create_shift')) }}
@endsection
                    ...
                    <div class="card-body">
                        <form action="{{ route("shift.store") }}" method="POST">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="time" class="form-control" id="start" name="start" value="{{ old("start") }}" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="time" class="form-control" id="finish" name="finish" value="{{ old("finish") }}" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="time" class="form-control" id="start_break" name="start_break" value="{{ old("start_break") }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="time" class="form-control" id="finish_break" name="finish_break" value="{{ old("finish_break") }}">
                                </div>
                            </div>
                            ...
                            {{-- <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" id="delta_day_of_start" name="delta_day_of_start" value="{{ old("delta_day_of_start") }}" step="any" required>
                                </div>
                            </div>
