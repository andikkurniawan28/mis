                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group" aria-label="manage">
                                            ...
                                            <button type="button" class="btn btn-danger btn-sm delete-btn" data-id="{{ $employee->id }}" data-name="{{ $employee->name }}">Delete</button>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            deleteButtons.forEach(button => {
                button.addEventListener('click', function(event) {
                    ...
                    const employee_name = this.getAttribute('data-name');
                    Swal.fire({
                        title: 'Are you sure?',
                        ...
                        if (result.isConfirmed) {
                            ...
                            form.setAttribute('action',
                                `{{ route('employee.destroy', ':id') }}`.replace(
                                    ':id', employee_id));
                            ...
                            name.setAttribute('value', employee_name);
