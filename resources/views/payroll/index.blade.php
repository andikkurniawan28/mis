        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="btn-group" role="group" aria-label="manage">
                    <a href="{{ route('payroll.create') }}" class="btn btn-sm btn-primary">Create</a>
                </div>
                <div class="table-responsive">
                    <span class="half-line-break"></span>
                    <table class="table table-bordered table-hovered" id="payroll_table" width="100%">
                        <thead>
                            <tr>
