                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group" aria-label="manage">
                                            ...
                                            <button type="button" class="btn btn-danger btn-sm delete-btn" data-id="{{ $account_group->id }}" data-name="{{ $account_group->name }}">Delete</button>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            deleteButtons.forEach(button => {
                button.addEventListener('click', function(event) {
                    ...
                    const account_group_id = this.getAttribute('data-id');
                    const account_group_name = this.getAttribute('data-name');
                    Swal.fire({
                        title: 'Are you sure?',
                        ...
                        if (result.isConfirmed) {
                            ...
                            form.setAttribute('action',
                                `{{ route('account_group.destroy', ':id') }}`.replace(
                                    ':id', account_group_id));
                            ...
                            name.setAttribute('value', account_group_name);
