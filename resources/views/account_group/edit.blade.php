                    ...
                    <div class="card-body">
                        <form action="{{ route("account_group.update", $account_group->id) }}" method="POST">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="id" name="id" value="{{ old("id", $account_group->id) }}" required autofocus>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="name" name="name" value="{{ old("name", $account_group->name) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control select2" id="financial_statement" name="financial_statement_id" width="100%" required>
                                        <option disabled>Select a {{ ucwords(str_replace('_', ' ', 'financial_statement')) }} :</option>
                                        @foreach ($financial_statements as $financial_statement)
                                            <option value="{{ $financial_statement->id }}" {{ $account_group->financial_statement_id == $financial_statement->id ? 'selected' : '' }}>
