...
@section('title')
    {{ ucwords(str_replace('_', ' ', 'edit_transaction_category')) }}
@endsection
        ...
        <div class="row">
            <div class="col-xxl">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{ route('transaction_category.update', $transaction_category->id) }}" method="POST">
                            @csrf @method('PUT')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="id" name="id" value="{{ old('id', $transaction_category->id) }}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="name" name="name" value="{{ old('name', $transaction_category->name) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control select2" id="deal_with" name="deal_with" required>
                                        <option value="customers" {{ $transaction_category->deal_with == 'customers' ? 'selected' : '' }}>Customers</option>
                                        <option value="suppliers" {{ $transaction_category->deal_with == 'suppliers' ? 'selected' : '' }}>Suppliers</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control select2" id="price_used" name="price_used" required>
                                        <option value="sell_price" {{ $transaction_category->price_used == 'sell_price' ? 'selected' : '' }}>sell_price</option>
                                        <option value="buy_price" {{ $transaction_category->price_used == 'buy_price' ? 'selected' : '' }}>buy_price</option>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control select2" id="stock_normal_balance" name="stock_normal_balance_id">
                                        @foreach($normal_balances as $normal_balance)
                                            <option value="{{ $normal_balance->id }}" {{ $transaction_category->stock_normal_balance_id == $normal_balance->id ? 'selected' : '' }}>
                                                {{ $normal_balance->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control select2" id="subtotal_account" name="subtotal_account_id" required>
                                        @foreach($accounts as $account)
                                            <option value="{{ $account->id }}" {{ $transaction_category->subtotal_account_id == $account->id ? 'selected' : '' }}>
                                                {{ $account->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control select2" id="subtotal_normal_balance" name="subtotal_normal_balance_id">
                                        @foreach($normal_balances as $normal_balance)
                                            <option value="{{ $normal_balance->id }}" {{ $transaction_category->subtotal_normal_balance_id == $normal_balance->id ? 'selected' : '' }}>
                                                {{ $normal_balance->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control select2" id="taxes_account" name="taxes_account_id" required>
                                        @foreach($accounts as $account)
                                            <option value="{{ $account->id }}" {{ $transaction_category->taxes_account_id == $account->id ? 'selected' : '' }}>
                                                {{ $account->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control select2" id="taxes_normal_balance" name="taxes_normal_balance_id">
                                        @foreach($normal_balances as $normal_balance)
                                            <option value="{{ $normal_balance->id }}" {{ $transaction_category->taxes_normal_balance_id == $normal_balance->id ? 'selected' : '' }}>
                                                {{ $normal_balance->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control select2" id="freight_account" name="freight_account_id" required>
                                        @foreach($accounts as $account)
                                            <option value="{{ $account->id }}" {{ $transaction_category->freight_account_id == $account->id ? 'selected' : '' }}>
                                                {{ $account->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control select2" id="freight_normal_balance" name="freight_normal_balance_id">
                                        @foreach($normal_balances as $normal_balance)
                                            <option value="{{ $normal_balance->id }}" {{ $transaction_category->freight_normal_balance_id == $normal_balance->id ? 'selected' : '' }}>
                                                {{ $normal_balance->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control select2" id="discount_account" name="discount_account_id" required>
                                        @foreach($accounts as $account)
                                            <option value="{{ $account->id }}" {{ $transaction_category->discount_account_id == $account->id ? 'selected' : '' }}>
                                                {{ $account->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control select2" id="discount_normal_balance" name="discount_normal_balance_id">
                                        @foreach($normal_balances as $normal_balance)
                                            <option value="{{ $normal_balance->id }}" {{ $transaction_category->discount_normal_balance_id == $normal_balance->id ? 'selected' : '' }}>
                                                {{ $normal_balance->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control select2" id="grand_total_account" name="grand_total_account_id" required>
                                        @foreach($accounts as $account)
                                            <option value="{{ $account->id }}" {{ $transaction_category->grand_total_account_id == $account->id ? 'selected' : '' }}>
                                                {{ $account->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control select2" id="grand_total_normal_balance" name="grand_total_normal_balance_id">
                                        @foreach($normal_balances as $normal_balance)
                                            <option value="{{ $normal_balance->id }}" {{ $transaction_category->grand_total_normal_balance_id == $normal_balance->id ? 'selected' : '' }}>
                                                {{ $normal_balance->name }}
                                            </option>
                                        @endforeach
                                    </select>
