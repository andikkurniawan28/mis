                    ...
                    <div class="card-body">
                        <form action="{{ route("material.update", $material->id) }}" method="POST">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" step="any" class="form-control" id="sell_price" name="sell_price" value="{{ old("sell_price", $material->sell_price) }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" step="any" class="form-control" id="buy_price" name="buy_price" value="{{ old("buy_price", $material->buy_price) }}">
                                </div>
                            </div>
